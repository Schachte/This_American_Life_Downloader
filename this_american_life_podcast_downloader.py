...
# New episodes are determined based on whether or not most recent podcast exists in directory
# If new episode is found, old one is removed and new one is downloaded
#####################################################################################################################
